        ...
        <div class="cont_wrap">
            ...
            <div class="cont_body">
            	...
            	<div id="contents">
					...
					<form:form name="noticeFrm" class="form-horizontal" action="/adm/updateNotice.do" modelAttribute="noticeVO" method="post" enctype="multipart/form-data">
                        ...
                        <fieldset>
                            ...
                            <div class="brd_write_area">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-7">
                                        <input type="text" id="inpSubject" name="title" class="form-control" placeholder="제목를 입력하세요" value="${noticeDetail.title }" required />
                                    </div>
                                </div>
                                <div class="form-group">
