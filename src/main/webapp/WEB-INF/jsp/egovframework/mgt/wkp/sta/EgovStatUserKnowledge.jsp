            ...
            <div class="cont_body">
                ...
                <div id="contents">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation" class="active"><a href="/adm/statUserKnowledge.do">최다 게시자</a></li>
                            ...
                            <div class="col-xs-12">
                                <div class="well mb_0">
                                    <form name="searchForm">
                                        ...
                                        <input type="hidden" name="type" value="statUserKnowledge">
                                        <fieldset>
                    ...
                    <table class="table table-bordered text-center table-hover">
                        <caption class="sr-only">최다 게시자 리스트</caption>
                        <colgroup>
                            <col style="width:6%;">
                            <col>
                            <col style="width:20%;">
...
<script>
    $(document).ready(function() {
        ...
        $('.dev-page').on('click', function (e) {
            ...
            form.attr("action", "/adm/statUserKnowledge.do");
            form.submit();
        });
