...
public class EgovMybaitsUtil {
	...
	private static final Logger UTIL_LOGGER = LoggerFactory.getLogger(EgovMybaitsUtil.class);
	...
	public static boolean isEmpty(Object o) throws IllegalArgumentException {
		...
		//2017.03.03 	조성원 	시큐어코딩(ES)-오류 메시지를 통한 정보노출[CWE-209]
			...
			UTIL_LOGGER.error("[IllegalArgumentException] Try/Catch...usingParameters Runing : "+ e.getMessage());
		}
