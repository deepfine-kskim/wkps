...
public class EgovFileMngServiceImpl extends EgovAbstractServiceImpl implements EgovFileMngService {
	 ...
	 */
	public long insertFileInf(FileVO fvo) {
		long atchFileNo = fvo.getAtchFileNo();
	 ...
	 */
	public long insertFileInfs(List<?> fvoList) {
		long atchFileNo = 0;

		if (fvoList.size() != 0) {
			atchFileNo = fileMngDAO.insertFileInfs(fvoList);
		}
