...
public class EgovEhgtCalcUtil {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(EgovEhgtCalcUtil.class);
	...
	public static String getEhgtCalc(String srcType, long srcAmount, String cnvrType) {
