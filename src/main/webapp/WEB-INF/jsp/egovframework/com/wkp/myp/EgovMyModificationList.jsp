                    ...
                    <tbody>
                        <c:forEach var="result" items="${resultList}" varStatus="status">
                            <tr>
                                ...
                                <td class="text-left">
                                    <p class="subject">
                                        <a href="javascript:;" class="dev-detail" data-request-no="${result.requestNo}"><c:out value="${result.title}"/></a>
...
<script>
    $(function () {
        ...
        $('.dev-detail').on('click', function (e) {
            ...
            const form = $("form[name=searchForm]");
            form.find("input[name=requestNo]").val(requestNo);
            form.attr("action", "/myp/modificationDetail.do");
            form.submit();
        });
