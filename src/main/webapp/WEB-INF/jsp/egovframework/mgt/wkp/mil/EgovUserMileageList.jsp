					...
					<table class="table table-bordered text-center table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="javascript:;" class="dev-detail" data-sid="${userMileage.sid }"><span class="text-blue">${userMileage.totalScore }</span></a></td>
							</tr>
							<!-- //루프 -->
							</c:forEach>
						</tbody>
...
<script>
    $(function () {
        ...
        $('.dev-detail').on('click', function (e) {
            ...
            form.attr("action", "/adm/userMileageDetail.do");
            form.submit();
        });
