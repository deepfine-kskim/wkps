                        ...
                        <fieldset>
                            ...
                            <div class="brd_write_area">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-7">
                                        <input type="text" class="form-control" id="title" required value="${banner.title }" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-xs-push-2">
                                        ...
                                        <div class="bnr_preview">
                                            <img  id="img_priview" src="${banner.fileStreCours }${banner.streFileNm }" class="img-responsive" alt="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-7">
                                        <input type="text" class="form-control" id="link" placeholder="URL을 입력하세요" value="${banner.link }">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-10">
                                        <label for="svPublic1" class="radio-inline">
                                            <input type="radio" id="svPublic1" name="useYn" value="Y" class="inp_tog" <c:if test="${banner.useYn=='Y' }">checked</c:if>> 노출
                                        </label> 
                                        <label for="svPublic2" class="radio-inline">
                                            <input type="radio" id="svPublic2" name="useYn" value="N" <c:if test="${banner.useYn=='N' }">checked</c:if>> 미노출
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-10">
                                        <textarea class="form-control" rows="3" id="etc">${banner.etc }</textarea>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
