...
public class EgovSysInfo {
	 ...
	 * @exception Exception
	*/
	public static Vector<Map<String, String>> getPrductList() {
	 ...
	 * @exception Exception
	*/
	public static String getPrductVersion(String server) {
	 ...
	 * @exception Exception
	*/
	public static String getPrductPort(String server) {
	 ...
	 * @exception Exception
	*/
	public static String getPrductStatus(String port) {
	...
	*/
	 ...
	 * @exception Exception
	*/
	public static String getOSPrductor() {
	...
	*/
	 ...
	 * @exception Exception
	*/
	public static List<String> getDiskName() {
	 ...
	 * @exception Exception
	*/
	public static float getDiskFullCpcty(String disk) {
	 ...
	 * @exception Exception
	*/
	public static float getDiskUsedCpcty(String disk) {
	 ...
	 * @exception Exception
	*/
	public static float getDiskFreeCpcty(String disk) {
	 ...
	 * @exception Exception
	*/
	public static float getMoryFullCpcty() {
	 ...
	 * @exception Exception
	*/
	public static float getMoryUsedCpcty() {
	 ...
	 * @exception Exception
	*/
	public static float getMoryFreeCpcty() {
	 ...
	 * @exception Exception
	*/
	public static boolean checkMoryCpcty(long memory) {
	...
	public static List<String[]> getProcessId() {
		...
		try {
			...
			if ("WINDOWS".equals(Globals.OS_TYPE)) {
				...
				if (p == null) {
					new EgovComException("Can't execute process...");
				}
			...
			LOGGER.error("[" + err.getClass() +"] :" + err.getMessage());
	...
	public static List<String[]> getProcessId(String processName) {
		...
		try {
			...
			if (Globals.OS_TYPE == null) {
				new EgovComException("Globals.OS_TYPE property value is needed!!!");
			}
