...
$(function() {
	...
	$("input:radio[name=repeat]").click(function(){
		var valueCheck = $('input:radio[name=repeat]:checked').val(); 

		if(valueCheck == "01"){
        	$("#divText1").hide();
        	$("#divText2").hide();
        }else if(valueCheck == "02"){
        	$("#divText1").show();
        	$("#divText2").hide();
        } else if(valueCheck == "03"){
        	$("#divText1").hide();
        	$("#divText2").show();
        }
    }); */
	...
	$("input:radio[name=repeat]").click(function(){
		...
		if(valueCheck == "01"){
        	...
        	$("#divText").show();
        	var element = document.getElementById('repeatType');
        	element.innerHTML = '주';
        } else if(valueCheck == "03"){
        	$("#divText").show();
        	var element = document.getElementById('repeatType');
        	element.innerHTML = '주';
        } else if(valueCheck == "04"){
        	$("#divText").show();
        	var element = document.getElementById('repeatType');
        	element.innerHTML = '개월';
        }
    });
	...
	$('#btn_save').click(function(){
		...
		var CALENDAR_REPEAT_CD =  $("input[name='repeat']:checked").val();
		
		if(CALENDAR_REPEAT_CD != "01" && $('input[name="repeatNum"]').val() == '') {
			alert("반복 횟수를 입력해 주세요.");
			return false;
		}
		
		var REPEAT_NUM = $('input[name="repeatNum"]').val();
		if(CALENDAR_REPEAT_CD != "01" && !(0 < parseInt(REPEAT_NUM))) {
			alert("반복 횟수는 1 이상 입력해 주세요.");
			return false;
		}
		...
		var param = { 
			CALENDAR_TYPE_CD : CALENDAR_TYPE_CD,
		   	CALENDAR_REPEAT_CD : CALENDAR_REPEAT_CD,
		   	REPEAT_NUM : REPEAT_NUM,
		   	//REPEAT_NUM1 : $('input[name="repeatNum1"]').val(),
		   	//REPEAT_NUM2 : $('input[name="repeatNum2"]').val(),
		   	//REPEAT_WEEK: $("input[name='repeatWeek']").val(),
		   	//REPEAT_DAY : $("input[name='repeatDay']").val(),
                            ...
                            <fieldset>
                                ...
                                <div class="brd_write_area">
                                        ...
                                        <div class="col-sm-5 col-lg-5">
                                            <div class="row type1">
                                                <div class="col-xs-6">
                                                    ...
                                                    <input type="text" class="form-control inp_date datetime" id="inpStartDate" name="inpStartDate" placeholder="시작날짜" required="required" />
                                                </div>
                                                <div class="col-xs-6">
                                                    <lable for="inpStartTime" class="sr-only">시작시간</lable>
                                                    <input type="text" class="form-control inp_time datetime" id="inpStartTime" name="inpStartTime" placeholder="시작시간" required="required" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-5 col-lg-5">
                                            <div class="row type1">
                                                <div class="col-xs-6">
                                                    ...
                                                    <input type="text" class="form-control inp_date datetime" id="inpEndDate" name="inpEndDate" placeholder="종료날짜" required="required" />
                                                </div>
                                                <div class="col-xs-6">
                                                    <lable for="inpEndTime" class="sr-only">종료시간</lable>
                                                    <input type="text" class="form-control inp_time datetime" id="inpEndTime" name="inpEndTime" placeholder="종료시간" required="required" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group inp_set_area">
                                        <label for="repeat1" class="col-sm-2 control-label"><span class="req">*</span> 반복</label>
                                        <div class="col-sm-10 tree_chk_area">
                                            <label for="repeat1" class="radio-inline">
                                                <input type="radio" id="repeat1" name="repeat" value="01" checked> 없음
                                            </label>
                                            <label for="repeat2" class="radio-inline">
                                                <input type="radio" id="repeat2" name="repeat" value="02"> 매주
                                            </label>
                                            <label for="repeat3" class="radio-inline">
                                                <input type="radio" id="repeat3" name="repeat" value="03"> 격주
                                            </label>
                                            <label for="repeat4" class="radio-inline">
                                                <input type="radio" id="repeat4" name="repeat" value="04"> 매월
                                            </label>
                                            <!-- <div id="divText1">
                                            	반복&nbsp;&nbsp;<input type="text" name="repeatNum1" value="" style="width: 50px; text-align: center;">&nbsp;&nbsp;주
                                            </div>
                                            <div id="divText2">
                                            	반복&nbsp;&nbsp;<input type="text" name="repeatNum2" value="" style="width: 50px; text-align: center;">&nbsp;개월
                                            	&nbsp;&nbsp;매달 &nbsp;&nbsp;<input type="text" name="repeatWeek" value="" style="width: 50px; text-align: center;">&nbsp;&nbsp;주차
                                            	&nbsp;&nbsp;<input type="text" name="repeatDay" value="" style="width: 50px; text-align: center;">&nbsp;&nbsp;요일
                                            </div> -->
                                            <div id="divText">
                                            	<input type="text" name="repeatNum" value="" style="width: 50px; text-align: center;">&nbsp;&nbsp;<span name="repeatType" id="repeatType"></span>&nbsp;반복
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group inp_set_area">
                                        ...
                                        <div class="col-sm-10 tree_chk_area">
                                            <label for="schCate1" class="radio-inline">
                                                <input type="radio" id="schCate1" name="schCate" value="01" checked> 개인일정
                                            </label>
                                            <label for="schCate2" class="radio-inline">
                                                <input type="radio" id="schCate2" name="schCate" value="02"> 도 주요 일정
                                            </label>
                                            <label for="schCate3" class="radio-inline">
                                                <input type="radio" id="schCate3" name="schCate" value="03"> 국 주요일정
                                            </label>
                                            <label for="schCate4" class="radio-inline">
                                                <input type="radio" id="schCate4" name="schCate" value="04"> 과 주요일정
                                            </label>
                                            <div>
                                                <label for="schCate5" class="radio-inline">
                                                    <input type="radio" id="schCate5" name="schCate" class="inp_tog" value="05"> 커뮤니티
                                                </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="schSubject" name="schSubject" placeholder="제목를 입력하세요" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="schMemo" class="col-sm-2 control-label"><span class="req">*</span> 내용</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" rows="6" id="schMemo" name="schMemo" placeholder="내용을 입력하세요" required></textarea>
                                            <div class="text-right">
                                                <label for="schMemoOpt" class="checkbox-inline">
                                                    <input type="checkbox" id="schMemoOpt" name="schMemoOpt" /> 대외비
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="schPlace" name="schPlace" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="schEntrant" class="col-sm-2 control-label">주 참석자</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="schEntrant" name="schEntrant" />
                                        </div>
                                    </div>
                                    <div class="form-group">
