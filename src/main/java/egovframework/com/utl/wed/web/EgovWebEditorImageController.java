...
public class EgovWebEditorImageController {
    ...
    public String imageUpload(MultipartHttpServletRequest request, Model model)  {
    ...
    public String imageUploadCk(@RequestParam(value="CKEditorFuncNum", required=false) String ckEditorFuncNum, HttpServletRequest request, HttpServletResponse response, Model model)  {
	 ...
	 * @
	 */
	private void uploadImageFiles(HttpServletRequest request, Model model)  {
    ...
    public void download(HttpServletRequest request, HttpServletResponse response)  {
		...
		if (subPath.indexOf("..") >= 0 )
			try {
				throw new EgovComException("Security Exception - illegal url called.");
