...
<!DOCTYPE html>
<!-- saved from url=(0031)http://105.0.1.229/idx/index.do -->
<html lang="ko"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">

    <link rel="shortcut icon" href="http://105.0.1.229/images/egovframework/com/favicon2209.ico">
    <link rel="icon" href="http://105.0.1.229/images/egovframework/com/favicon2209.ico">
    <title>도정지식포털</title>
    ...
    <link rel="stylesheet" href="/css/egovframework/com/wkp/landing.css">
...
<div id="wrap">
    <div id="skipNav">
        <a href="http://105.0.1.229/idx/index.do#contents">본문 바로가기</a>
        <a href="http://105.0.1.229/idx/index.do#gnbList">주메뉴 바로가기</a>
    </div>

    <div class="landing-page">
        <div class="landing-page-container">
            <p class="landing-page-logo"><img src="/images/egovframework/com/landing/logo_landing.png" alt="변화의 중심 기회의 경기 도정지식포털" /></p>
            <div class="landing-page-content">
                <p class="landing-page-img"><img src="/images/egovframework/com/landing/img_landing.png" alt="" /></p>
    ...
    <div id="pageBg" class="hidden-lg hidden-md"></div>
</div>
<!-- //WRAP -->
...
<script src="/js/egovframework/com/wkp/deepfine.common.js"></script>
