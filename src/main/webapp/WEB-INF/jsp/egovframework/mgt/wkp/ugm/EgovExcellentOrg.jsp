                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <input type="text" id="mbSrch" name="ou" class="form-control" placeholder="부서명 검색(2글자 이상 입력)" />
			...
			$.ajax({
				...
				success : function(data) {
		           	...
		           	for(var i=0; i < data.orgList.length; i++){
		           		$('#orgList').append('<tr>'+
		           				'<td><label for="brdChk'+i+'"><input type="radio" id="brdChk'+i+'" name="ouCode" value="'+data.orgList[i].ouCode+'"  required="required"/></label></td>'+
		           				'<td>'+data.orgList[i].ou+'</td>'+
		           				'</tr>');
		           	}
				},
				error : function(){
