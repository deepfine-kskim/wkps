...
$(function() {
    ...
    function search(page){
    	var form = $("form[name=pagingForm]");
      	...
      	form.attr("action", "communityAdminConfirm.do");
      	form.submit();
    }
                    ...
                    <div id="contents" class="col-md-9">
                        ...
                        <div class="page-body">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation" class="active"><a href="communityAdminConfirm.do?cmmntyNo=${community.cmmntyNo}">가입요청 관리</a></li>
                            ...
                            <div class="table-responsive">
                                <table class="table text-center table-bordered table-hover brd_list all_chks_frm">
                                    ...
                                    <c:forEach items="${list}" var="mem">
                                        ...
                                        <tr>
                                            <td colspan="4" class="empty">가입요청 회원이 없습니다.</td>
                                        </tr>
                                        </c:if>
                                    </tbody>
                                </table>
                            ...
                            <div class="btn_area">
                                <a href="#" class="btn btn-primary" onclick="aprv('Y')">승인</a>
                                <a href="#" class="btn btn-danger"  onclick="aprv('N')">거절</a>
                            </div>
